...
const initialPackages = [
  { id: 1001, package_name: "60 + 30 UC", playerIdd: 1846249952, card_amount: 852282, card_type: "Master", price_usd: 0.99, uc_amount: 10, bonus_uc: 30, total_uc: 60, picURL: BG_Diamond1 },
  { id: 1002, package_name: "300 + 25 UC", playerIdd: 1846249842, card_amount: 852282, card_type: "Visa", price_usd: 4.99, uc_amount: 15, bonus_uc: 25, total_uc: 325, picURL: BG_Diamond1 },
  { id: 1003, package_name: "600 + 60 UC", playerIdd: 1846249732, card_amount: 852282, card_type: "Visa Golden", price_usd: 9.99, uc_amount: 20, bonus_uc: 60, total_uc: 660, picURL: BG_Diamond1 },
  { id: 1004, package_name: "1500 + 300 UC", playerIdd: 1846249622, card_amount: 852282, card_type: "Visa Golden", price_usd: 24.99, uc_amount: 30, bonus_uc: 300, total_uc: 1800, picURL: BG_Diamond1 },
  { id: 1005, package_name: "3000 + 850 UC", playerIdd: 1846249512, card_amount: 852282, card_type: "Visa", price_usd: 49.99, uc_amount: 40, bonus_uc: 850, total_uc: 3850, picURL: BG_Diamond1 },
  { id: 1006, package_name: "6000 + 2100 UC", playerIdd: 1846249402, card_amount: 852282, card_type: "Master", price_usd: 99.99, uc_amount: 60, bonus_uc: 2100, total_uc: 8100, picURL: BG_Diamond1 },
  { id: 1007, package_name: "7000 + 2500 UC", playerIdd: 1846249362, card_amount: 852282, card_type: "Visa Golden", price_usd: 130.99, uc_amount: 100, bonus_uc: 2500, total_uc: 9500, picURL: BG_Diamond1 },
  { id: 1008, package_name: "8000 + 3100 UC", playerIdd: 1846249272, card_amount: 852282, card_type: "Master", price_usd: 150.99, uc_amount: 160, bonus_uc: 3100, total_uc: 11100, picURL: BG_Diamond1 },
  { id: 1009, package_name: "9000 + 3600 UC", playerIdd: 1846249182, card_amount: 852282, card_type: "Visa", price_usd: 175.99, uc_amount: 200, bonus_uc: 3600, total_uc: 12600, picURL: BG_Diamond1 },
  { id: 1010, package_name: "10000 + 4200 UC", playerIdd: 1846249092, card_amount: 852282, card_type: "Visa Golden", price_usd: 200.99, uc_amount: 300, bonus_uc: 4200, total_uc: 14200, picURL: BG_Diamond1 },
  { id: 1011, package_name: "11000 + 4500 UC", playerIdd: 1846241355, card_amount: 852282, card_type: "Master", price_usd: 220.99, uc_amount: 400, bonus_uc: 4500, total_uc: 15500, picURL: BG_Diamond1 },
  { id: 1012, package_name: "12000 + 4800 UC", playerIdd: 1846249142, card_amount: 852282, card_type: "Visa", price_usd: 250.99, uc_amount: 500, bonus_uc: 4800, total_uc: 16800, picURL: BG_Diamond1 }
];
...
function FailedUC() {
  ...
  return (
    <div className="h-auto bg-[rgb(20,27,61)] min-h-screen p-2 flex justify-around items-center">
      ...
      <div className="h-[auto] w-[1000px] setting-main flex items-center flex-col justify-center bg-[#171F45] mx-auto my-5 py-5">
                  ...
                  <div className="card-body grid grid-cols-1 bg-[#1B234D] rounded-lg p-5 lg:grid-cols-2 gap-6">
                    ...
                    <div className="payment-submit-part bg-[#141B3D] p-6 rounded-lg shadow-md">
                      ...
                      <div className="item-info flex items-center mb-4">
                        <img src={Diamond} alt="" className="w-16 h-16 mr-4" />
                        <h2 className="uc-amount text-lg text-white">{selectedPackage.uc_amount}k Diamonds</h2>
                      </div>
                                  ...
                                  <div className="text-center mt-4">
                                    {
                                      paymentStatus ? (
                                        <>
                                          ...
                                          <h2 className="text-1xl font-bold text-white ">{selectedPackage.uc_amount}k Diamonds SENDING FAILED</h2>
                                          <h3 className="text-lg text-white">VIA FreeFire ID: {searchVal} </h3>
                                          <Link className='border border-red-600 inline-block mt-4 px-4 py-2 rounded-lg text-white hover:bg-red-600 transition duration-300' onClick={handleback} to="/homepage/failedfreefires">Home</Link>
                                        </>
                                      ) : (
                                        <>
                                          <div className="parent-loader">
                                          ...
                                          <h2 className="text-2xl relative font-bold text-white ">Diamonds Sending...</h2>
                                          <h3 className="text-lg text-white">Please Wait For Sending Diamonds
                                          </h3>
